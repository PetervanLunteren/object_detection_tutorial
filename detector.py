# Script taken from https://github.com/abdelrahman-gaber/tf2-object-detection-api-tutorial/blob/master/detector.py
# (abdelrahman-gaber). Part of the the object detection tutorial
# https://github.com/PetervanLunteren/object_detection_tutorial.

# This script defines functions used in 'use_model_TF2.py'.
